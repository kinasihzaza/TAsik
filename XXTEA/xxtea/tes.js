...
function toUint32Array(bytes, includeLength) {
    ...
    var v;
    if (includeLength) {                            //g masuk
        v = new Uint32Array(n + 1);
        v[n] = length;
    }
    else {                                          //
        v = new Uint32Array(n);                     // n dijadiin unsigned int
    }
...
function encrypt(data, key) {
    if (typeof data === 'string') data = toBytes(data);                 //plain text dirubah ke Bytes
    if (typeof key === 'string') key = toBytes(key);                    //key dirubah ke Bytes
    if (data === undefined || data === null || data.length === 0) {
        return data;
    }
    return toUint8Array(encryptUint32Array(toUint32Array(data, true), toUint32Array(fixk(key), false)), false);
                                            //parameter dari fungsi encryptUint32Array 
}
...
// var plainToBytes = toBytes(str);
// var keyToBytes = toBytes(key);

// console.log('Plain to Bytes');
// console.log(plainToBytes);
// console.log('Key to Bytes');
// console.log(keyToBytes);

// var plainToUint32Array = toUint32Array(plainToBytes, true)
// console.log('plain to uint 32 array')
// console.log(plainToUint32Array)
// console.log('\nFixk')
// var fixkData = fixk(key);
// console.log(fixkData);

// console.log('key to uint 32 array')
// var keyToUint32Array = toUint32Array(fixk(key), false)
// console.log(keyToUint32Array)

// console.log('encrypt Uint32 Array')
// var hasilEncryptToUint32Array = encryptUint32Array(plainToUint32Array, keyToUint32Array)
// console.log(hasilEncryptToUint32Array)

// console.log('hasil encrypt to Uint8 Array')
// var ret = new Buffer(toUint8Array(hasilEncryptToUint32Array, false)).toString('base64')
// console.log(ret)
//var decrypt_data = decryptToString(encrypt_data, key);
//console.assert(str === decrypt_data);
//console.log(decrypt_data);

console.log('\nPlain to Bytes');
var byteP = toBytes(str)
console.log(byteP)

console.log('\nKey to Bytes');
var byteK = toBytes(key)
console.log(byteK)
...
console.log('\nPlain to uint 32 array')
var a = toUint32Array(byteP, true)
console.log(a)

console.log('\nkey to uint 32 array')
var b = toUint32Array(fk, false)
console.log(b)

console.log('\nhasilEncryptToUint32Array')
var c = encryptUint32Array(a, b)
console.log(c)

console.log('\nhasilEncryptToUint8Array')
var d = toUint8Array(c, false)
console.log(d)

console.log('\nhasilToString')
var ret = new Buffer(d).toString('base64');
console.log(ret)
